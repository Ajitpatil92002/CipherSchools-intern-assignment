...
const Graph = () => {
  const CustomTooltip = () => (
    <div className="rounded-xl overflow-hidden bg-gray-700">
      <div className="flex items-center justify-between p-2 text-gray-200">
    ...
    <div className="flex p-4 h-full flex-col">
      <div className="">
        <div className="flex items-center">
          ...
          <div className="ml-2 text-gray-200">Last 9 Months</div>
          <div className="ml-6 w-5 h-5 flex justify-center items-center rounded-full bg-gray-700 text-white">
            ?
          </div>
        </div>
